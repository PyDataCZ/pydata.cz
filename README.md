...
#### Vladimír Dušek - Dealing with today's web scraping challenges in Python ([video](https://youtu.be/SH9oqmTpxiI))
...
#### Jan Kislinger - Forged in Rust, Spoken in Python ([slides](https://github.com/jankislinger/forged-in-rust), [video](https://youtu.be/ES7GsF_1Y_I))
...
#### Jakub Kramata - Big Bank Data in Migration: From In-House CSV to Parquet in Amazon S3 ([video](https://www.youtube.com/watch?v=g6nMnHbq1Ys))
...
#### Milan Ondrašovič - Unlocking Efficiency: The Power of Vectorization ([video](https://www.youtube.com/watch?v=YaJOxJ9k0LA),  [slides](talks/milan_ondrasovic-ThePowerOfVectorization_PyData.pdf))
